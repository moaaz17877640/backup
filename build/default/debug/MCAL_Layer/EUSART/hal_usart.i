# 1 "MCAL_Layer/EUSART/hal_usart.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MCAL_Layer/EUSART/hal_usart.c" 2
...
# 1 "MCAL_Layer/EUSART/hal_usart.h" 1
# 11 "MCAL_Layer/EUSART/hal_usart.h"
# 1 "MCAL_Layer/EUSART/../../MCAL_Layer/GPIO/hal_gpio.h" 1
# 12 "MCAL_Layer/EUSART/../../MCAL_Layer/GPIO/hal_gpio.h"
...
# 12 "MCAL_Layer/EUSART/../../MCAL_Layer/GPIO/hal_gpio.h" 2

# 1 "MCAL_Layer/EUSART/../../MCAL_Layer/GPIO/../Mcal_Std_Types.h" 1
# 12 "MCAL_Layer/EUSART/../../MCAL_Layer/GPIO/../Mcal_Std_Types.h"
# 1 "MCAL_Layer/EUSART/../../MCAL_Layer/GPIO/../Std_Libraries.h" 1
# 12 "MCAL_Layer/EUSART/../../MCAL_Layer/GPIO/../Std_Libraries.h"
...
# 12 "MCAL_Layer/EUSART/../../MCAL_Layer/GPIO/../Std_Libraries.h" 2
...
# 13 "MCAL_Layer/EUSART/../../MCAL_Layer/GPIO/../Std_Libraries.h" 2
...
# 14 "MCAL_Layer/EUSART/../../MCAL_Layer/GPIO/../Std_Libraries.h" 2
# 12 "MCAL_Layer/EUSART/../../MCAL_Layer/GPIO/../Mcal_Std_Types.h" 2

# 1 "MCAL_Layer/EUSART/../../MCAL_Layer/GPIO/../compiler.h" 1
# 11 "MCAL_Layer/EUSART/../../MCAL_Layer/GPIO/../compiler.h"
...
# 11 "MCAL_Layer/EUSART/../../MCAL_Layer/GPIO/../compiler.h" 2
# 13 "MCAL_Layer/EUSART/../../MCAL_Layer/GPIO/../Mcal_Std_Types.h" 2
...
# 13 "MCAL_Layer/EUSART/../../MCAL_Layer/GPIO/hal_gpio.h" 2

# 1 "MCAL_Layer/EUSART/../../MCAL_Layer/GPIO/../device_config.h" 1
# 14 "MCAL_Layer/EUSART/../../MCAL_Layer/GPIO/hal_gpio.h" 2
# 32 "MCAL_Layer/EUSART/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef enum{
    LOGIC_LOW,
            LOGIC_HIGH
}logic_t;
...
# 11 "MCAL_Layer/EUSART/hal_usart.h" 2

# 1 "MCAL_Layer/EUSART/../../MCAL_Layer/Interrupt/mcal_internal_interrupt.h" 1
# 12 "MCAL_Layer/EUSART/../../MCAL_Layer/Interrupt/mcal_internal_interrupt.h"
...
# 53 "MCAL_Layer/EUSART/../../MCAL_Layer/Interrupt/mcal_interrupt_config.h"
typedef enum{
...
# 12 "MCAL_Layer/EUSART/hal_usart.h" 2
...
static void eusart_baudrate_configuration(const eusart_t *_eusa){
    ...
    if(BAUDRATE_ASYNCHRONOUS_8BIT_LOW_SPEED ==_eusa->baud_rate_formula ){
        ...
        BAUDCONbits.BRG16 = 0 ;
        TXSTA1bits.BRGH = 0 ;
    baud_temp = (20000000 /(float)_eusa->baud_rate_value /64.0) - 1 ;
    }
        ...
        BAUDCONbits.BRG16 = 0 ;
        TXSTA1bits.BRGH = 1 ;
    baud_temp = (20000000 /(float)_eusa->baud_rate_value /16.0) - 1 ;
    }
     ...
     TXSTA1bits.SYNC =0 ;
        BAUDCONbits.BRG16 = 1 ;
        TXSTA1bits.BRGH = 1 ;
         baud_temp = (20000000 /(float)_eusa->baud_rate_value /4.0) - 1 ;
    }
...
static void EUSART_ASYC_Tx_init(const eusart_t *_eusa) {
    ...
    if (1 == _eusa->tx_cfg.asyn_tx_enable) {
        TXSTAbits.TXEN = 1;
        if (1 == _eusa->tx_cfg.asyn_tx_9bit_select) {
            TXSTAbits.TX9 = 1;
        } else if (0 == _eusa->tx_cfg.asyn_tx_9bit_select) {
            TXSTAbits.TX9 = 0;
        } else {

        }

        if (1 == _eusa->tx_cfg.asyn_tx_interrupt_cfg) {
            PIE1bits.TXIE = 1;
        } else if (0 == _eusa->tx_cfg.asyn_tx_interrupt_cfg) {
            PIE1bits.TXIE = 0;
        } else {
...
# 205 "MCAL_Layer/EUSART/hal_usart.c"
        (INTCONbits.PEIE = 1);
        (INTCONbits.GIE = 1);
...
static void EUSART_ASYC_Rx_init(const eusart_t *_eusa) {
    ...
    if (1 == _eusa->rx_cfg.asyn_rx_enable) {
        RCSTAbits.CREN = 1;
        if (1 == _eusa->rx_cfg.asyn_rx_9bit_select) {
            RCSTAbits.RX9 = 1;
        } else if (0 == _eusa->rx_cfg.asyn_rx_9bit_select) {
            RCSTAbits.RX9 = 0;
        } else {

        }

        if (1 == _eusa->rx_cfg.asyn_rx_interrupt_cfg) {
            PIE1bits.RCIE = 1;
        } else if (0 == _eusa->rx_cfg.asyn_rx_interrupt_cfg) {
            PIE1bits.RCIE = 0;
        } else {
...
# 253 "MCAL_Layer/EUSART/hal_usart.c"
        (INTCONbits.PEIE = 1);
        (INTCONbits.GIE = 1);
